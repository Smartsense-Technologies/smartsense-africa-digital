...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "SmartSense is an AI-driven innovation and digital transformation company building intelligent technology solutions for Africa." },
      { property: "og:title", content: "About SmartSense Technologies" },
      { property: "og:description", content: "An AI-driven innovation company localizing intelligent technology for Africa." },
    ],
  }),
  component: AboutPage,
});
