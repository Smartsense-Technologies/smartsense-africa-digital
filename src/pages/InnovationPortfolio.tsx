...
const NOW: Item[] = [
  { name: "Flam-Powered Mixed Reality Experiences", description: "Immersive interactive experiences across print, OOH, TV, packaging, smart cards and events.", users: "Brands, agencies, media owners, public institutions", impact: "Measurable engagement, richer storytelling, multi-channel campaign performance.", status: "Now in Market" },
];

const FOCUS: Item[] = [
  { name: "Smart Finance & SME Intelligence Layer", description: "An emerging intelligence layer for SME visibility, embedded workflows and economic insight.", users: "Financial institutions, public sector, SME ecosystems", impact: "Better data for finance, policy and SME growth decisions.", status: "Strategic Focus" },
  { name: "SmartLearn AI", description: "Mobile-first AI learning and workforce readiness solutions for AI literacy and digital skills.", users: "Students, workforce, public training programs", impact: "Accessible upskilling and AI fluency at scale.", status: "In Development" },
  { name: "SmartAccess", description: "Smart verification, QR-based access, visitor management and institutional access workflows.", users: "Estates, schools, hospitals, ministries, facilities", impact: "Safer, more efficient and trackable access management.", status: "In Development" },
  { name: "SenseHub / Media & Content Intelligence", description: "AI-powered media, trend, content and discovery tools for smarter creation and distribution.", users: "Media owners, brands, creators, public communicators", impact: "Smarter content strategies and audience reach.", status: "Strategic Focus" },
];
  ...
  return (
    <>
      <PageMeta
        ...
        description="An ecosystem of active deployments, partner-enabled technologies and platforms under development for African markets."
        ogTitle="Innovation Portfolio | SmartSense"
        ogDescription="Active deployments, strategic focus areas and platforms in development."
      />
